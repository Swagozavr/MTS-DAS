Вот версия в чистом **Markdown (.md)**, которую можно просто вставить в `README.md`:
...
Если хочешь, могу ещё сделать **более “GitHub-friendly” README (с бейджами, swagger ссылкой и разделом API Docs)** — такой выглядит заметно сильнее для портфолио.
```
